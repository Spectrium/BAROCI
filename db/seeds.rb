...
diana.length.times do |i|
	Commune.create(name: diana[i], region_id: (1))
end

sava.length.times do |i|
	Commune.create(name: sava[i], region_id: (2))
end

itasy.length.times do |i|
	Commune.create(name: itasy[i], region_id: (3))
end
...
ankaratra.length.times do |i|
	Commune.create(name: ankaratra[i], region_id: (5))
end

bongolava.length.times do |i|
	Commune.create(name: bongolava[i], region_id: (6))
end

sofia.length.times do |i|
	Commune.create(name: sofia[i], region_id: (7))
end

boeny.length.times do |i|
	Commune.create(name: boeny[i], region_id: (8))
end

betsiboka.length.times do |i|
	Commune.create(name: betsiboka[i], region_id: (9))
end

melaky.length.times do |i|
	Commune.create(name: melaky[i], region_id: (10))
end
...
atsinanana.length.times do |i|
	Commune.create(name: atsinanana[i], region_id: (12))
end

analanjirofo.length.times do |i|
	Commune.create(name: analanjirofo[i], region_id: (13))
end
...
matsiatra.length.times do |i|
	Commune.create(name: matsiatra[i], region_id: (15))
end

vatovavy.length.times do |i|
	Commune.create(name: vatovavy[i], region_id: (16))
end

atsimoatsinanana.length.times do |i|
	Commune.create(name: atsimoatsinanana[i], region_id: (17))
end

ihorombe.length.times do |i|
	Commune.create(name: ihorombe[i], region_id: (18))
end

menabe.length.times do |i|
	Commune.create(name: menabe[i], region_id: (19))
end

atsimoandrefana.length.times do |i|
	Commune.create(name: atsimoandrefana[i], region_id: (20))
end

androy.length.times do |i|
	Commune.create(name: androy[i], region_id: (21))
end

anosy.length.times do |i|
	Commune.create(name: anosy[i], region_id: (22))
end
